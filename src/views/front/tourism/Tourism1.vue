...
const data = reactive({
  ...
  options: [
    ...
    {value: 'Option2', label: '国家文物局关于印发《革命文物保护利用“十四五”专项规划》的通知', pdf: '/policy/国家文物局关于印发《革命文物保护利用“十四五”专项规划》的通知.pdf'},
    {value: 'Option3', label: '国务院办公厅关于印发“十四五”文物保护和科技创新规划的通知', pdf: '/policy/国务院办公厅关于印发“十四五”文物保护和科技创新规划的通知.pdf'},
    ...
    {value: 'Option6', label: '数字化为红色文化资源保护传承再添动能', pdf: '/policy/数字化为红色文化资源保护传承再添动能.pdf'},
    {value: 'Option7', label: '习近平总书记：加强文化遗产保护传承 弘扬中华优秀传统文化', pdf: '/policy/习近平总书记：加强文化遗产保护传承 弘扬中华优秀传统文化.pdf'},
    {value: 'Option8', label: '习近平总书记：用好红色资源 赓续红色血脉 努力创造无愧于历史和人民的新业绩', pdf: '/policy/习近平总书记：用好红色资源 赓续红色血脉 努力创造无愧于历史和人民的新业绩.pdf'},
    {value: 'Option9', label: '在新时代大力弘扬红色文化', pdf: '/policy/在新时代大力弘扬红色文化.pdf'},
    {value: 'Option10', label: '中共中央办公厅 国务院办公厅印发《关于实施革命文物保护利用工程（2018－2022年）的意见》', pdf: '/policy/中共中央办公厅 国务院办公厅印发《关于实施革命文物保护利用工程（2018－2022年）的意见》.pdf'},
  ],
});
